...
* React.js     
* Angular Framework     
* TypeScript, JavaScript, EcmaScript - NPM, Yarn, Webpack       
* GraphQL      
* Redux / Flux (Data State Management)      
* jQuery     
* Bootstrap, Material UI, D3.js (Data Visualization), DevExtreme UI components    
...
### Back End    
* C#, .NET Core, .Net (DotNet), Mono - Windows Form, WPF, MVC, MFC, ASP.NET Web Forms     
* Node.js - Express.js, Apollo     
* NoSQL - MongoDB, Firebase FireStore, Azure Cosmos, Redis         
* WebRTC, Socket.io, SignalR      
* SQL Databases - MSSQL, MySQL, PostgreSQL, SQLite     
* Message Brokers - Azure Service Bus, RabbbitMQ     
* Authentication - OAuth, JWT, ASP.NET Core Identity       
* Elixir, Phoenix Framework - Experience in building low latency fault tolerant systems with Pheonix Framework     
* Python - Experience in building GUI/Task Automations, Web Scrappers and AI Applications      
* Go - Expereince in building background jobs and CLI services     
...
* Web API Development     
* Web Development (Traditional web applications and Single Page Applications with React.js & Angular Framework)     
* Data warehouse Applications and ETL Tools Development     
* Progressive Web Apps Development         
* GIS (Geographical Information Systems) with ArcGIS            
...
* Design patterns (State, Singleton, Command, Template Method etc.)         
